...
public class XMLUtil {
	...
	public static void saveXMLDocumentToFile(Document doc, String encoding, String strFileName) throws IOException {
	...
	public static void saveXMLDocumentToOutputStream(Document doc, String encoding, OutputStream outputstream) throws IOException {
		if (encoding == null || encoding.length() == 0) {
			encoding = "UTF-8";
		}
		OutputFormat outputFormat = new OutputFormat();
	...
	public static Document loadXMLFile(String strFileName) throws DocumentException {
		SAXReader saxReader = new SAXReader();
	...
	static public void outputXML(Document xmldoc, String xslname, Writer out) throws Exception {
		if (xslname != null) {
			ProcessingInstruction pi = DocumentHelper.createProcessingInstruction("xml-stylesheet", "href=\"" + xslname + "\" type=\"text/xsl\"");
		...
		transformer.transform(new DocumentSource(xmldoc), new StreamResult(out));
		out.flush();
		out.close();
	}
	 ...
	 */
	static public void transformXml(Document xmldoc, String xslname, Writer out) throws TransformerException {
		TransformerFactory factory = TransformerFactory.newInstance();
		Transformer transformer = xslname == null ? factory.newTransformer() : factory.newTransformer(new StreamSource(xslname));
		transformer.setOutputProperty("encoding", "GB2312");
